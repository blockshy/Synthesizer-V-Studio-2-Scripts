...
2. In SV2.1.2+, open the `Pitch to Parameter (SV2)` panel in the Scripts side panel.
...
- For SV1/older hosts, use `BlockShy/Pitch_To_Param_SV1/Pitch_To_Param_SV1.lua`.
